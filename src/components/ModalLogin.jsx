...
const TransitionsModal = () => {
  ...
  const loginWindowOpen = useSelector((state) => state.loginWindowSlice);
            ...
            >
              <div className="gap-5 flex flex-col w-full text-center text-xl font-medium">
                <div className="flex justify-center items-center gap-3">
                  <Button
                    sx={{
                      color: loginWindowOpen ? "var(--green-primary)" : "black",
                      textTransform: "capitalize",
                      fontFamily: "Cera Pro",
                      fontSize: "20px",
                    }}
                    variant="text"
                    onClick={() => dispatch(toggleLoginWindow(true))}
                  >
                    Login
                  </Button>
                  <span>|</span>
                  <Button
                    sx={{
                      color: loginWindowOpen ? "black" : "var(--green-primary)",
                      fontFamily: "Cera Pro",
                      fontSize: "20px",
                      textTransform: "capitalize",
                    }}
